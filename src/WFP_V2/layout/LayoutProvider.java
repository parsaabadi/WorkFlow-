...
public class LayoutProvider extends AbstractLayoutProvider {
    ...
    public void layout(ElkNode layoutGraph, IElkProgressMonitor progressMonitor) {
        ...
        progressMonitor.begin("TestAlgorithm", 2);
        progressMonitor.log("Algorithm began");
        // Retrieve several properties
        ElkPadding padding = layoutGraph.getProperty(LayoutOptions.PADDING);
        
        double edgeEdgeSpacing = layoutGraph.getProperty(LayoutOptions.SPACING_EDGE_EDGE);
        double edgeNodeSpacing = layoutGraph.getProperty(LayoutOptions.SPACING_EDGE_NODE);
        double nodeNodeSpacing = layoutGraph.getProperty(LayoutOptions.SPACING_NODE_NODE);
